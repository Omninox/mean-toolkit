...
A library project created with Angular CLI for sharing services that can be used in Angular and Ionic apps. This library was generated with [Angular CLI](https://github.com/angular/angular-cli) version 7.2.0.
