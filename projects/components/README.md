...
A library project built with Angular CLI for sharing common Angular and Ionic UI components. This library was generated with [Angular CLI](https://github.com/angular/angular-cli) version 7.2.0.
